...
def main():
    ...
    parser.add_argument("--method", type=str, default="iql", choices=["maddpg", "iql", "bc", "bc_iql"], help="训练方法")
    ...
    env.reset()
    obs_dim = env.obs_dim
    logger.info(f"Method={args.method}, N={args.num_uav}, obs_dim={obs_dim}, device={device}")
    ...
    if args.method == "bc":
        ...
        # 收集专家数据
        expert_data = trainer.collect_expert_data(num_episodes=args.bc_expert_episodes)
