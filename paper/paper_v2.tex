...
\begin{tabular}{cccc}
\toprule
$N$ & $\bar{P}_{\text{int}}$ & Inference (s) & Channels/UAV \\
\midrule
10 & 0.062 & 0.33 & 1.0 \\
20 & 0.277 & 1.56 & 0.5 \\
30 & -- & -- & 0.33 \\
...
As $N$ increases beyond the number of orthogonal channels ($n_{\text{ch}}=10$), frequency reuse becomes unavoidable. At $N=20$, each channel is shared by 2 UAVs on average, increasing co-channel interference. The interference probability increases from 0.062 ($N=10$) to 0.277 ($N=20$), reflecting this fundamental spectral congestion. Importantly, the inference time scales linearly ($\sim$0.15\,s per UAV), maintaining real-time feasibility.
