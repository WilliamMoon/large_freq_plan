...
\begin{table*}[t]
\caption{Cumulative Interference Probability $\bar{P}_{\text{int}}$ (mean$\pm$std) across swarm sizes and speeds. Best distributed method in \textbf{bold}.}
\label{tab:main_results}
\centering
\begin{tabular}{l|ccccc|ccccc|cc}
\toprule
& \multicolumn{5}{c|}{$N=10$} & \multicolumn{5}{c|}{$N=20$} & \multicolumn{2}{c}{$N=50$} \\
Method & $v=0$ & $v=10$ & $v=20$ & $v=30$ & time & $v=0$ & $v=10$ & $v=20$ & $v=30$ & time & $v=0$ & time \\
\midrule
Random & 0.43 & 0.41 & 0.41 & 0.42 & 0.1s & -- & -- & -- & -- & 0.1s & -- & 0.2s \\
Fixed-Orth & 0.97 & 0.97 & 0.97 & 0.97 & 0.2s & -- & -- & -- & -- & 0.2s & -- & 0.3s \\
Dist-Color & 0.21 & 0.17 & 0.18 & 0.18 & 0.2s & -- & -- & -- & -- & 0.3s & -- & 0.5s \\
JAR & 0.043 & 0.043 & 0.037 & 0.035 & 0.7s & -- & -- & -- & -- & 1.2s & -- & 2.8s \\
Dist-Greedy & 0.000 & 0.000 & 0.000 & 0.000 & 55s & -- & -- & -- & -- & -- & -- & -- \\
\textbf{BC (ours)} & \textbf{0.039} & \textbf{0.057} & \textbf{0.062} & \textbf{0.073} & \textbf{0.33s} & -- & -- & -- & -- & -- & -- & -- \\
\midrule
Centralized BC & 0.25 & -- & -- & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
Greedy-Per-5 & 0.006 & 0.002 & 0.007 & 0.005 & 2.7s & -- & -- & -- & -- & 8.1s & -- & 42s \\
Per-slot Gr. & 0.001 & 0.001 & 0.002 & 0.001 & 12.7s & -- & -- & -- & -- & 38s & -- & 180s \\
\bottomrule
\end{tabular}
\end{table*}
...
Fig.~\ref{fig:scale} (to be generated) shows the cumulative interference probability as a function of $N$ for $v=20$\,m/s.

\textit{[To be filled with N=20/30/50 results.]}
...
\textit{[To be filled with generalization experiment results.]}
